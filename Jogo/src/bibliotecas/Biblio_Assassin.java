...
public class Biblio_Assassin extends Biblioteca {
	...
	linhas = new int[1];
	 ...
	 tx[0] = "<html>A porta se abre e voc\u00EA consegue"
				+ "<br/>entrar dentro da casa."
				+ "<br/>Ariandra est\u00E1 no quarto de h\u00F3spedes e \u00E9"
				+ "<br/>para l\u00E1 que com cautela voc\u00EA se encaminha."
				+ "<br/>A porta do quarto est\u00E1 aberta"
				+ "<br/>e voc\u00EA entra."
				+ "<br/>Uma flecha voa na sua dire\u00E7\u00E3o,"
				+ "<br/>mas voc\u00EA consegue desviar por pouco. "
				+ "<html>";
      linhas[0] =7;
      choice = "<html>Ariandra:" + "<br/><br/>Quem \u00E9 voc\u00EA e o que quer aqui?" + "<html>";
		...
		break;
	case 2://se errar
		 tx[0] = "<html>A porta n\u00E3o se abre e um alarme"
					+ "<br/>\u00E9 disparado, \u00E9 melhor voc\u00EA ir "
					+ "<br/>embora antes que seja capturado."
					+ "<br/>O tempo passa e voc\u00EA"
					+ "<br/>pode tentar outra vez ou em outro local."
					+ "<html>";
	      linhas[0] =4;
	}}
	...
	public void CassiusmeMandou(int x) {
		...
		case 1://voce é uma...
	      ...
	      tx[1] = "<html>Ariandra:\" + \"<br/><br/>Que utilidade voc\u00EA"
	    		    + "<br/>daria para minhas habilidades?"  
					+ "<html>";
	      linhas[1] =3;
	      
	      tx[2] =  "<html>Voc\u00EA:" + "<br/><br/>N\u00F3s estamos formando um?"
			 +"<br/>pequeno grupo para proteger Helaria"
			 +"<br/>Sua participa\u00E7\u00E3o ser\u00E1 de grande valor."
			 + "<html>";
	      linhas[2] =4;
	      
	      tx[3] =  "<html>Ariandra:" + "<br/><br/>Quem mais" 
	    		  + "<br/>est\u00E1 nesse grupo?"  
	 			 + "<html>";
	      linhas[3] =3;
	      
	      tx[4] =  "<html>Voc\u00EA:" + "<br/><br/>O an\u00E3o Letos,"
	    		  + "<br/>a sacerdotisa Terraira, Cassius e eu."
	    		  + "<html>";
	      linhas[4] =3;
	      
	      tx[5] =  "<html>Ariandra:" + "<br/><br/>Voc\u00EA conseguiu reunir"
	    		  + "<br/>um grupo e tanto"
	    		  + "<br/>E suas habilidades tamb\u00E9m n\u00E3o"
	    		  + "<br/>s\u00E3o porcas, n\u00E3o \u00E9 qualquer"
	    		  + "<br/>um que consegue desviar"
	    		  + "<br/>das minhas flechas."
	    		  + "<html>";
	      linhas[5] =7;
	      
	      tx[6] =  "<html>Voc\u00EA:" + "<br/><br/>Ent\u00E3o voc\u00EA est\u00E1 dentro?"
	    		  + "<html>";
	      linhas[6] =2;
	      
	      tx[7] =  "<html>Ariandra:" + "<br/><br/>Pode contar comigo"
	    		  + "<html>";
	      linhas[7] =2;
	      
	      tx[8] = "<html>O dia termina e voc\u00EA volta"
		...
		public void porqueDeveriaMeImportar(int x) {
	      ...
	      tx[1] = "<html>Voc\u00EA segue pelo esgoto"
					 + "<br/> at\u00E9 encontrar uma entrada para a parte"  
					 + "<br/> subterr\u00E2nea da Catedral,"  
					 + "<br/> onde fica a pris\u00E3o."  
					 + "<br/> \u00C9 um lugar escuro e \u00FAmido,"  
					 + "<br/> fede a medo e morte."
					+ "<html>";
	      linhas[1] =5;  
	      ...
	      linhas[4] =2 ; 
			...
			public void vitoria3Recrutados() {
				tx = new String[5];
			linhas = new int[5];
				tx[0] = "<html>Voc\u00EAs conseguem conter"
						 + "<br/>nas chamas uma for\u00E7a"  
						 + "<br/>significativa de Bethesda."  
						 + "<br/>Agora com as tropas"  
						 + "<br/> flageladas, Bethesda j\u00E1"  
						 + "<br/>n\u00E3o representa uma"  
						 + "<br/>amea\u00E7a t\u00E3o grande." 
						+ "<html>";
		      linhas[0] =6; 
		      
		      tx[1] = "<html>Helaria v\u00EA as chamas"
						 + "<br/>e envia suas tropas"  
						 + "<br/>para acabar com o que"  
						 + "<br/>resta das tropas de Bethesda."  
						 + "<br/>Uma violenta batalha se"  
						 + "<br/>inicia e voc\u00EA e seu"  
						 + "<br/>grupo tomam parte." 
						+ "<html>";
		      linhas[1] =6; 
		      
		      tx[2] = "<html>As tropas de Bethesda"
						 + "<br/>s\u00E3o dizimadas enquanto"  
						 + "<br/>que as de Helaria est\u00E3o"  
						 + "<br/>quase inteiras. O rei."  
						 + "<br/>deseja saber quem foi"  
						 + "<br/>o respons\u00E1vel por essa"  
						 + "<br/>vit\u00F3ria e encontra voc\u00EAs." 
						+ "<html>";
		      linhas[2] =6; 
		      
		      tx[3] = "<html>Todos recebem o t\u00EDtulo"
						 + "<br/>de Guardi\u00E3o Protetor de"  
						 + "<br/>Helaria e sempre ser\u00E3o"  
						 + "<br/>ouvidos nas reuni\u00F5es reais"  
						 + "<br/>Helaria muda muito depois"  
						 + "<br/>da guerra e de sua "  
						 + "<br/>ascens\u00E3o" 
						+ "<html>";
		      linhas[3] =6; 
		      
		      tx[4] = "<html>O povo passa a ter"
						 + "<br/>mais voz e cada"  
						 + "<br/>vez mais se aproxima"  
						 + "<br/>de um lugar ideal"  
						 + "<br/>a se viver."  
						 + "<br/>PARAB\u00C9NS!"  
			...
			public void vitoriaDoisRecrutados() {
				tx = new String[6];
				linhas = new int[6];
					tx[0] = "<html>Grande parte das tropas"
							 + "<br/>do acampamento s\u00E3o mortas"  
							 + "<br/>ou aleijadas, mas ainda"  
							 + "<br/>tem uma quantidade"  
							 + "<br/> significativa pronta"  
							 + "<br/>para lutar."  
							+ "<html>";
			      linhas[0] =5; 
			      
			      tx[1] = "<html>Uma batalha se inicia"
							 + "<br/>e tropas de Bethesda"  
							 + "<br/>e Helaria alertadas"  
							 + "<br/> pelo inc\u00EAndio chegam"  
							 + "<br/>para participar"  
							+ "<html>";
			      linhas[1] =4; 
			      
			      tx[2] = "<html>A batalha \u00E9 violenta"
							 + "<br/>e muitos soldados dos dois"  
							 + "<br/>lados s\u00E3o mortos,"  
							 + "<br/>mas no final Helaria"  
							 + "<br/>vence e a cidade"  
							 + "<br/>permanece intacta."  
							+ "<html>";
			      linhas[2] =5; 
			      
			      tx[3] = "<html>Depois da guerra o Rei"
							 + "<br/>procura pelos respons\u00E1veis"  
							 + "<br/>pela vit\u00F3ria. Todos"  
							 + "<br/>voc\u00EAs s\u00E3o recompensados"  
							 + "<br/>com o t\u00EDtulo de Lordes"  
							 + "<br/>Guerreiros de Helaria"  
							+ "<html>";
			      linhas[3] =6; 
			      
			      tx[4] = "<html>Depois dessa guerra"
							 + "<br/>Helaria come\u00E7a a se"  
							 + "<br/>militarizar intensamente"  
							 + "<br/>ao ponto do ex\u00E9rcito se"  
							 + "<br/>tornar a institui\u00E7\u00E3o"  
							 + "<br/>mais importante"  
							 + "<br/>do Estado." 
							+ "<html>";
			      linhas[4] =6; 
			      
			      tx[5] = "<html>Voc\u00EAs tiveram a vit\u00F3ria,"
							 + "<br/>mas voc\u00EA s\u00F3 n\u00E3o sabe"  
							 + "<br/>at\u00E9 que ponto"  
							 + "<br/>ela valeu a pena."  
							 + "<br/>PARAB\u00C9NS SOLDADO!"  
							 + "<br/>VOCÊ TERMINOU O JOGO!"  
			...
			public void vitoriaUmRecrutado() {
				tx = new String[6];
				linhas = new int[6];
					tx[0] = "<html>As tropas inimigas s\u00E3o"
							 + "<br/>muito numerosas e voc\u00EAs"  
							 + "<br/>conseguem eliminar apenas"  
							 + "<br/>uma parte delas."  
							 + "<br/>O inc\u00EAndio desperta"  
							 + "<br/>o restante das tropas"
							 + "<br/>de Bethesda" 
							+ "<html>";
			      linhas[0] =5; 
			      
			      tx[1] = "<html>Uma violenta batalha"
							 + "<br/>\u00E9 iniciada marcada"  
							 + "<br/>no in\u00EDcio pelo avan\u00E7o"  
							 + "<br/> de Bethesda at\u00E9 entrar"  
							 + "<br/>nos muros da cidade."  
							+ "<html>";
			      linhas[1] =4; 
			      
			      tx[2] = "<html>Quando a guerra chega"
							 + "<br/>no interior da cidade,"  
							 + "<br/>Helaria come\u00E7a a virar"  
							 + "<br/>a situa\u00E7\u00E3o e Bethesda"  
							 + "<br/>come\u00E7a a perder."  
							+ "<html>";
			      linhas[2] =4; 
			      
			      tx[3] = "<html>Voc\u00EAs lutam bravamente"
							 + "<br/>at\u00E9 suas \u00FAltimas for\u00E7as,"  
							 + "<br/>mas no fim perecem"  
							 + "<br/>para proteger Helaria."   
							+ "<html>";
			      linhas[3] =3; 
			      
			      tx[4] = "<html>Grande parte de Helaria"
							 + "<br/>\u00E9 destru\u00EDda, mas no"  
							 + "<br/>fim ela sai vitoriosa."  
							 + "<br/>O Rei procura pelos"  
							 + "<br/>respons\u00E1veis pelo inc\u00EAndio"  
							 + "<br/>que possibilitou a vit\u00F3ria"  
							 + "<br/>e descobre suas hist\u00F3rias." 
							+ "<html>";
			      linhas[4] =6; 
			      
			      tx[5] = "<html>Um monumento \u00E9 erguido"
							 + "<br/>em suas homenagens"  
							 + "<br/>para que todos se"  
							 + "<br/>lembrem dos salvadores"  
							 + "<br/>de Helaria para sempre."  
							+ "<html>";
			      linhas[5] =4; 
			      
			      tx[6] = "<html>Os anos passam e Helaria"
							 + "<br/>\u00E9 reconstru\u00EDda. Hoje,"  
							 + "<br/>todos sabem da hist\u00F3ria"  
							 + "<br/>da grande guerra e de"  
							 + "<br/>quem foram os her\u00F3is"  
							 + "<br/>que deram suas vidas"  
							 + "<br/>para salvar a cidade."  
							+ "<html>";
			      linhas[6] =4;
			      tx[6] = "<html>Os anos passam e Helaria"
							 + "<br/>\u00E9 reconstru\u00EDda. Hoje,"  
			      ...
			      tx[7] = "<html>PARAB\u00C9NS AVENTUREIRO!"
							 + "<br/>VOCÊ TERMINOU O JOGO! "  
							+ "<html>";
			      linhas[7] =1; 
				}
