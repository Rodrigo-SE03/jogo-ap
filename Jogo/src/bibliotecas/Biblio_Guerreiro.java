...
public class Biblio_Guerreiro extends Biblioteca {
	...
	public void grr_2(int x) { // apos termino do metodo ir para o mapa
		...
		tx[13] = "<html>A conversa continua por mais algum " + "<br/>tempo, Alexander te esclarece sobre os "
				...
				+ "<br/>est\u00E3o se aproximando de Helaria e tem " + "<br/>previs\u00E3o de chegada de tr\u00EAs dias. "+ "<html>";
		linhas[13] = 5;
	...
	public void grr_6 () { // caso derrote a hidra
		...
		tx[0] = "<html>Agora a porta para os arquivos est\u00E1  " + "<br/>aberta e voc\u00EA pode entrar. Demora "
				+ "<br/>algumas horas, mas eventualmente voc\u00EA " + "<br/>consegue encontrar o livro que cont\u00E9m os  "
	...
	public void grr_3_torre() { // dialogo antes do puzzle do labirinto na primeira vez que ele entra na torre
		...
		linhas = new int[19];	
		  ...
		  tx[1] = "<html>L\u00E1 voc\u00EA conversa com Muriel, a l\u00EDder"+ "<br/>dessa inst\u00E2ncia da Ordem Arcana."+"<html>";
		  linhas[1] = 1;
	
		  tx[2] = "<html>- O que voc\u00EA procura aqui,"+ player.getNome() +" ? "+ "<br/>- Muriel diz."+"<html>";
		  linhas[2] = 1;

		  tx[3] = "<html>- Preciso da ajuda de voc\u00EAs. A guerra"+ "<br/>contra Bethesda se aproxima e sua ajuda "
				  + "<br/>ser\u00E1 imprescind\u00EDvel. - Voc\u00EA diz" +"<html>";
		  linhas[3] = 2;

		  tx[4] = "<html>- Muito bem, voc\u00EA quer nossa ajuda e n\u00F3s"+ "<br/>queremos te ajudar, mas primeiro preciso "
				  + "<br/>que voc\u00EA prove que tipo de pessoa voc\u00EA " + "<br/>\u00E9, para sabermos se vale a pena lutar ao "
				  + "<br/>seu lado. - Muriel diz."+"<html>";
		  linhas[4] = 4;
		  
		  tx[5] = "<html>- Muito bem, o que voc\u00EA quer que eu "+ "<br/>fa\u00E7a. - Voc\u00EA diz."+"<html>";
		  linhas[5] = 1;

		  tx[6] = "<html>- Existe um livro de feiti\u00E7os dentro de um "+ "<br/>labirinto aqui. O Tratado da Magia, \u00E9 seu "
				  + "<br/>nome. Eu preciso que voc\u00EA o traga para" + "<br/>mim at\u00E9 o final do dia. - Muriel diz."+"<html>";
		  linhas[6] = 3;

		  tx[7] = "<html>- Ah, mas vai ser f\u00E1cil ent\u00E3o. - Voc\u00EA diz"+"<html>";
		  linhas[7] = 0;

		  tx[8] = "<html>- A\u00ED que voc\u00EA se engana apenas aqueles "+ "<br/>que s\u00E3o puros de cora\u00E7\u00E3o conseguir\u00E3o "
				  + "<br/>juntar corretamente suas tr\u00EAs partes. " + "<br/>- Muriel diz."+"<html>";
		  linhas[8] = 3;

		  tx[9] = "<html>- S\u00E3o tr\u00EAs partes? - Voc\u00EA pergunta um "+ "<br/>pouco receoso"+"<html>";
		  linhas[9] = 1;
		  
		  tx[10] = "<html>- Precisamente, espalhadas pelo labirinto. "+ "<br/>- Muriel diz."+"<html>";
		  linhas[10] = 1;		  

		  tx[11] = "<html>- Tudo bem, antes do fim do dia voc\u00EA ter\u00E1"+ "<br/>esse livro. - Voc\u00EA diz. "+"<html>";
		  linhas[11] = 1;
	...
	public void grr_4_torre_win() {
		...
		linhas = new int[1];	
		  ...
		  tx[0] = "<html>Voc\u00EA consegue juntar todas as partes e "+ "<br/>entrega o livro para Muriel. Ela e sua"
			 + "<br/>equipe ir\u00E3o se juntar a voc\u00EA nesta guerra." + "<br/>"+ "<br/>Voc\u00EA volta para o Castelo da Guarda "
			 + "<br/>Real para descansar." +"<html>";
		  linhas[0] = 5;	
	...
	public void grr_4_torre_lose() { //  se nao houver mais tempo mostrar uma mensagem diferente
		...
		linhas = new int[1];	
		  ...
		  tx[0] = "<html>Voc\u00EA sente uma grande energia indo em "+ "<br/>sua dire\u00E7\u00E3o e precisa sair do labirinto "
			 + "<br/>para que o equil\u00EDbrio seja reestabelecido." + "<br/>"+ "<br/>Algumas horas se passam e voc\u00EA pode "
			 + "<br/>tentar novamente." +"<html>";
		  linhas[0] = 5;	
	}
	...
	public void grr_3_alameda() { // dialogo antes do puzzle da porta na primeira vez que ele entra na alameda
		...
		tx[0] = "<html>Voc\u00EA vai para a Alameda dos Tr\u00EAs "+ "<br/>Ponteiros a procura do ladr\u00E3o Kelastar."
				+ "<br/>Segundo suas fontes ele costuma ficar no " + "<br/>Beco da Garganta Degolada e \u00E9 para l\u00E1 "
				+ "<br/>que voc\u00EA vai."+"<html>";
		linhas[0] = 4;
		...
		tx[10] = "<html>- Ok, al\u00E9m de afirmar o \u00F3bvio, o que voc\u00EA"
				+ "<br/>veio fazer aqui? - diz Kelastar."
				+"<html>";
		linhas[10] = 1;

		tx[11] = "<html>- Preciso das suas habilidades. Uma "+ "<br/>guerra est\u00E1 vindo e estou montando uma "
				+ "<br/>equipe. Os melhores da Guarda Real, da" + "<br/>Torre Arcana e da Alameda dos Tr\u00EAs"
				+ "<br/>Ponteiros e n\u00F3s queremos voc\u00EA e os seus"+ "<br/>dentro. - Voc\u00EA diz." +"<html>";
		linhas[11] = 5;

		tx[12] = "<html>- Hum... Parece interessante, mas o que "+ "<br/>eu ganho com isso? - Kelastar pergunta."+"<html>";
		linhas[12] = 1;
		
		tx[13] = "<html>- Sobreviv\u00EAncia, se voc\u00EA n\u00E3o nos ajudar"+ "<br/>a cidade cair\u00E1. - Voc\u00EA."+"<html>";
		linhas[13] = 1;

		tx[14] = "<html>- Disso eu sei, mas quero saber al\u00E9m "+ "<br/>disso. Estou falando de dinheiro, t\u00EDtulos. -"
		+ "<br/>Kelastar." +"<html>";
		linhas[14] = 2;

		tx[15] = "<html>- N\u00E3o posso prometer t\u00EDtulos, mas ter\u00E1 "+ "<br/>todo o dinheiro com que puder sonhar. "
				+ "<br/>- Voc\u00EA diz." +"<html>";
		linhas[15] = 2;

		tx[16] = "<html>- Eu posso sonhar com quantidades bem "+ "<br/>altas... De qualquer forma, eu preciso "
				+ "<br/>saber se posso confiar em voc\u00EA, s\u00F3 que" + "<br/>ao modo de Tr\u00EAs Ponteiros. - diz Kelastar."+"<html>";
		linhas[16] = 3;

		tx[17] = "<html>- O que voc\u00EA quer que eu fa\u00E7a? - Voc\u00EA diz."+"<html>";
		linhas[17] = 0;

		tx[18] = "<html>- Est\u00E1 vendo aquela porta? Prove para"+ "<br/>mim que voc\u00EA consegue abri-la com sua "
				+ "<br/>intelig\u00EAncia, assim saberei o tipo de " + "<br/>pessoa que lutarei ao lado. - diz Kelastar."+"<html>";
		linhas[18] = 3;
	...
	public void grr_4_alameda_win() {
		...
		linhas = new int[3];	
		  ...
		  tx[0] = "<html>- Voc\u00EA tem seu valor. A Alameda dos Tr\u00EAs"+ "<br/>Ponteiros lutar\u00E1 ao seu lado. - Kelastar diz."+"<html>";
		  linhas[0] = 1;
		
		  tx[1] = "<html>- Agrade\u00E7o. - Voc\u00EA diz."+"<html>";
		  linhas[1] = 0;
	...
	public void grr_4_alameda_lose() {
		...
		linhas = new int[1];	
		  ...
		  tx[0] = "<html> A porta n\u00E3o se abre. Voc\u00EA olha para "+ "<br/>Kelastar e ele te d\u00E1 um olhar permitindo"
		  +"<br/>mais uma tentativa. "+"<html>";
		  linhas[0] = 2;
	}
	...
	public void grr_5_com_map() { // consegue mapa - minigame daniel
		...
		linhas = new int[4];	
		  ...
		  tx[0] = "<html> 	O terceiro dia est\u00E1 chegando ao fim e "
			 ...
			 + "<br/>que o inimigo pode usar para um r\u00E1pido"
			 + "<br/>acesso ao interior da cidade." +"<html>";
		  linhas[0] = 5;
		  
		  tx[1] = "<html>	Voc\u00EA vai dormir para se preparar para o"
			 + "<br/>dia seguinte."+"<html>";
		  linhas[1] = 1;
		  
		  tx[2] = "<html> No dia seguinte sua equipe se encontra "
			 + "<br/>na entrada do esgoto e voc\u00EAs "
		  ...
		  tx[3] = "<html>  Voc\u00EA ouve sons, as tropas de Bethesda "
			 + "<br/>est\u00E3o se aproximando, voc\u00EAs devem ficar "
			 + "<br/>a postos." +"<html>";
		  linhas[3] = 2;
	}
	...
	public void grr_6_muriel() { // se conseguir mapa e arrombou porta
		...
		linhas = new int[4];	
		  ...
		  tx[0] = "<html> 	Voc\u00EAs est\u00E3o conseguindo conter grande "
			 + "<br/>parte das tropas inimigas, mas uma "
			 + "<br/>quantidade significativa ainda consegue" 
			 + "<br/>passar por voc\u00EAs. Bethesda consegue "
			 + "<br/>invadir um peda\u00E7o da cidade e tanto l\u00E1 "
			 + "<br/>em cima, como aqui em baixo est\u00E1 tendo" 
			 +"<br/>uma violenta batalha."+"<html>";
		  linhas[0] = 6;
		  
		  tx[1] = "<html> 	No fim do dia as tropas de Bethesda"
			 + "<br/>minguam e Helaria sai vencedora da "
			 + "<br/>guerra, no entanto uma parte significativa  " 
			 + "<br/>da cidade foi destru\u00EDda e muitas pessoas "
			 + "<br/>foram mortas."+"<html>";
		  linhas[1] = 4;
		  ...
		  tx[3] = "<html>	Voc\u00EAs s\u00E3o homenageados pelo rei e  "
			 + "<br/>recebem t\u00EDtulos e posses. Agora voc\u00EA \u00E9"
			 + "<br/>escutado pelo rei. Voc\u00EA pretende levar "
			 + "<br/>Helaria para um novo rumo e "
	...
	public void grr_6_ninguem() {
		...
		linhas = new int[2];	
		  ...
		  tx[0] = "<html>	As tropas inimigas s\u00E3o muitas e uma "
			 + "<br/>parte significativa delas consegue passar "
			 + "<br/>por voc\u00EAs. Na cidade e embaixo dela se" 
			 + "<br/>d\u00E3o batalhas violentas."+"<html>";
		  linhas[0] = 3;
		  
		  tx[1] = "<html>	Voc\u00EAs resistem at\u00E9 suas \u00FAltimas for\u00E7as,  "
			 + "<br/>mas quando o \u00FAltimo soldado de "
			 + "<br/>Bethesda cai por suas m\u00E3os, voc\u00EA cai " 
			 + "<br/>junto com ele. Helaria conseguiu vencer a "
			 + "<br/>guerra e voc\u00EA sabe disso, agora voc\u00EA "
			 + "<br/>pode morrer em paz."+"<html>";
		  linhas[1] = 6;
	...
	public void grr_6_lose() {
		...
		tx[0] = "<html>		As tropas inimigas s\u00E3o muito numerosas,"
				+ "<br/>elas conseguem esmagar suas defesas e "
				+ "<br/>passar sem problemas, deixando uma " 
				+ "<br/>mancha com seu sangue no ch\u00E3o. "
				+ "<br/>Helaria \u00E9 totalmente invadida e n\u00E3o tem"
				+ "<br/>esperan\u00E7as de sobreviv\u00EAncia, destinada " 
				+ "<br/>ao esquecimento."+"<html>";
		linhas[0] = 6;
		
		tx[1] = "<html>		Esse \u00E9 o mesmo destino de seu corpo "
				+ "<br/>inerte, ser esquecido e devorado pelos"
				+ "<br/>vermes. Um her\u00F3i esquecido de uma  " 
				+ "<br/>cidade esquecida. "+"<html>";
		linhas[1] = 3;
	}
	...
	public void grr_5_sem_mapa() {
		...
		tx[0] = "<html>		O terceiro dia chega, mas sem os "
				...
				+ "<br/>pontos de fraqueza subterr\u00E2neos, por " 
				+ "<br/>isso sua equipe \u00E9 encarregada de"
				+ "<br/>defender o port\u00E3o principal."+"<html>";
		linhas[0] = 4;
		
		tx[1] = "<html>		De noite voc\u00EA vai para seu quarto "
				+ "<br/>e descansa at\u00E9 o dia seguinte. Amanhece"
				+ "<br/>e chega a hora, voc\u00EA deve se arrumar " 
				+ "<br/>para a batalha."+"<html>";
		linhas[1] = 3;
		
		tx[2] = "<html>		Voc\u00EA encontra seus companheiros "
				+ "<br/>na porta da cidade, prontos para morrer "
	...
	public void grr_6_sem_mapa_win_dois_rec() {
		...
		tx[0] = "<html>		Voc\u00EAs est\u00E3o conseguindo conter o "
				+ "<br/>avan\u00E7o das tropas inimigas com"
				+ "<br/>facilidade, at\u00E9 em excesso. Ent\u00E3o, voc\u00EAs " 
				+ "<br/>recebem um ataque por tr\u00E1s, parte das"
				+ "<br/>tropas inimigas pegou uma rota pelos"
				+ "<br/>subterr\u00E2neos e te surpreendeu. Voc\u00EAs" 
				+ "<br/>est\u00E3o lutando em duas frentes."+"<html>";
		linhas[0] = 6;
		
		tx[1] = "<html>		A batalha est\u00E1 complicada, mas voc\u00EA tem"
				+ "<br/>os n\u00FAmeros necess\u00E1rios para a vit\u00F3ria. "
				+ "<br/>Mesmo com voc\u00EAs lutando em duas" 
				+ "<br/>frentes Bethesda come\u00E7a a recuar e n\u00E3o "
				+ "<br/>demora muito a ser derrotada. Uma "
				+ "<br/>pequena parte de Helaria \u00E9 destru\u00EDda, e " 
				+ "<br/>muitas vidas foram perdidas, mas Helaria"
				+ "<br/>permanece."+"<html>";
		linhas[1] = 7;
		
		tx[2] = "<html>		Voc\u00EAs s\u00E3o homenageados pelo rei e"
				+ "<br/>recebem t\u00EDtulos e ouro, saciando a "
				+ "<br/>vontade de Kelastar. Voc\u00EA recebe um " 
				+ "<br/>cargo de conselheiro do Rei e tem muitos"
				+ "<br/>planos ambiciosos para a cidade. Helaria "
	...
	public void grr_6_sem_mapa_win_um_rec() {
		...
		tx[0] = "<html>		Voc\u00EAs est\u00E3o conseguindo segurar as "
				+ "<br/>tropas inimigas com relativa facilidade, "
				+ "<br/>mas s\u00E3o surpreendidos por um ataque" 
				...
				+ "<br/>mas no fim do dia as tropas de Bethesda "
				+ "<br/>minguem e Helaria sai vitoriosa."+"<html>";
		linhas[0] = 8;
		
		tx[1] = "<html>		O Rei decide homenagear sua equipe por"
				+ "<br/>ser a primeira linha de defesa da cidade."
				+ "<br/>Todos que sobreviveram recebem t\u00EDtulos " 
				+ "<br/>e posses e voc\u00EA recebe um lugar especia"
				+ "<br/>no Conselho da Guerra Real. O Rei"
				+ "<br/>planeja militarizar a cidade e voc\u00EA tem um" 
				+ "<br/>voc\u00EA tem um papel importante nesses "
				+ "<br/>planos."+"<html>";
		linhas[1] = 7;
		
		tx[2] = "<html>		Helaria um Estado Militar. At\u00E9 o"
				+ "<br/>dia de sua morte voc\u00EA se perguntou se "
				+ "<br/>suas decis\u00F5es na vida e na guerra foram " 
				+ "<br/>as corretas." +"<html>";
		linhas[2] = 5;
	...
	public void grr_6_sem_mapa_win_sem_rec() {
		...
		tx[0] = "<html>		Voc\u00EAs est\u00E3o conseguindo conter "
				...
				+ "<br/>uma grande quantidade de tropas de "
				+ "<br/>Bethesda ataca voc\u00EAs por tr\u00E1s, elas"
				+ "<br/>chegaram pelos subterr\u00E2neos da cidade. " +"<html>";
		linhas[0] = 5;
		
		tx[1] = "<html>		Voc\u00EAs est\u00E3o em uma grande  "
				+ "<br/>desvantagem num\u00E9rica, de dez para um, "
				+ "<br/>mas como se diz, um soldado de Helaria" 
				+ "<br/>vale por dez outros."
				+ "<br/><br/>Voc\u00EAs lutam at\u00E9 suas \u00FAltimas"
				+ "<br/>for\u00E7as, at\u00E9 o \u00FAltimo soldado de Bethesda"
				+ "<br/>cair por suas m\u00E3os nuas, contigo caindo " 
				+ "<br/>tamb\u00E9m."+"<html>";
		linhas[1] = 8;
		
		tx[2] = "<html>		Helaria sai vitoriosa, mas \u00E9 quase"
				+ "<br/>totalmente destru\u00EDda. Todos os que"
				+ "<br/>lutaram ao seu lado caem junto contigo. A " 
				+ "<br/>\u00FAnica coisa que ainda os mantinha vivos "
				+ "<br/>era a necessidade de proteger Helaria," 
				+ "<br/>mas quando o \u00FAltimo soldado de"
				+ "<br/>Bethesda caem eles sabem que podem " 
				+ "<br/>morrer em paz."+"<html>";
		linhas[2] = 7;

		tx[3] = "<html>		O Rei decide homenagear todos "
				+ "<br/>aqueles que ca\u00EDram para proteger a "
				+ "<br/>cidade com um monumento que est\u00E1 " 
				+ "<br/>sendo constru\u00EDdo ao mesmo tempo que a "
				+ "<br/>cidade \u00E9 reconstru\u00EDda."+"<html>";
		linhas[3] = 4;
		
		tx[4] = "<html>		Todos se lembrar\u00E3o para sempre  "
				+ "<br/>dos her\u00F3is que morreram para proteger "
	...
	public void grr_6_sem_mapa_derrota() {
		...
		tx[0] = "<html>		As tropas inimigas s\u00E3o muitas e"
				...
				+ "<br/>tr\u00E1s. Ao que parece algumas tropas de" 
				+ "<br/>Bethesda entraram em Helaria pelos "
				+ "<br/>subterr\u00E2neos."+"<html>";
		linhas[0] = 4;
		
		tx[1] = "<html>		Voc\u00EAs est\u00E3o em menor n\u00FAmero e"
				+ "<br/>lutando em duas frentes, n\u00E3o tem como "
				+ "<br/>conseguir a vit\u00F3ria." +"<html>";
		linhas[1] = 2;
		
		tx[2] = "<html>		Helaria cai e com ela caem os "
				+ "<br/>sonhos e as esperan\u00E7as de todos seus"
				+ "<br/>habitantes, reduzidos a manchas de " 
				+ "<br/>sangue no ch\u00E3o. Uma cidade destru\u00EDda"
				+ "<br/>que ser\u00E1 esquecida pelo tempo."+"<html>";
		linhas[2] = 4;
	
		tx[3] = "<html>		Essa \u00E9 a hist\u00F3ria de Helaria e de seu "
				+ "<br/>Her\u00F3i ca\u00EDdo."+"<html>";
		linhas[3] = 1;
	}
