...
public class Biblio_Guerreiro extends Biblioteca {
	...
	public void grr_5_catedral_cinismo() { // minigame da hidra
		...
		tx[15] = "Aparentemente ele responde \u00E0uma espec\u00EDfica m\u00E1quina de "
				+ " som, no entanto ela n\u00E3o est\u00E1 emsua posse, logo s\u00F3 te resta "
				+ " enfrent\u00E1-lo. ";
	...
	public void grr_3_torre() { // dialogo antes do puzzle do labirinto na primeira vez que ele entra na torre
		...
		if (masculino) {
			...
			tx[17] = "Você:\n\nObrigado, agora se prepare para sejuntar a minha equipe.";

		} else {

			tx[17] = "Você:\n\nObrigada, agora se prepare para sejuntar a minha equipe.";
	...
	public void grr_3_alameda() { // dialogo antes do puzzle da porta na primeira vez que ele entra na alameda
		...
		tx[0] = "Voc\u00EA vai para a Alameda dos Tr\u00EAs "
				...
				+ " Beco da Garganta Degolada e \u00E9 para l\u00E1que voc\u00EA vai.";
		...
		tx[12] = "Kalastar:\n\nHum... Parece interessante, mas o queeu ganho com isso?";
		...
		tx[16] = "Kalastar:\n\n Eu posso sonhar com quantidades bemaltas... De qualquer forma, eu preciso "
		...
		tx[18] = "Kalastar:\n\nEst\u00E1 vendo aquela porta? Prove para"
				...
				+ " intelig\u00EAncia, assim saberei o tipo depessoa que lutarei ao lado.";
	...
	public void grr_5_com_map() { // consegue mapa - minigame daniel
		...
		tx[2] = "No dia seguinte sua equipe se encontrana entrada do esgoto e voc\u00EAs "
				+ " prosseguem at\u00E9 a parte central, melhor posi\u00E7\u00E3o para montar uma emboscada.";

		tx[3] = "Voc\u00EA ouve sons, as tropas de Bethesda "
				+ " est\u00E3o se aproximando, voc\u00EAs devem ficara postos.";
	...
	public void grr_6_kelastar() { // se conseguir mapa e arrombou porta
		...
		tx[0] = "Voc\u00EAs est\u00E3o conseguindo conter astropas inimigas, mas elas n\u00E3o param de"
	...
	public void grr_6_sem_mapa_win_dois_rec() {
		...
		tx[0] = "Voc\u00EAs est\u00E3o conseguindo conter oavan\u00E7o das tropas inimigas com"
		...
		tx[2] = "Voc\u00EAs s\u00E3o homenageados pelo rei e"
				+ " recebem t\u00EDtulos e ouro, saciando avontade de Kelastar. Voc\u00EA recebe um "
