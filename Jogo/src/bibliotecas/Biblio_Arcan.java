...
public class Biblio_Arcan extends Biblioteca {
	...
	public void arcan2(int y) {
		...
		if (masculino) {
			...
			tx[x + 7] = "Artemisia:" + "\n\n" + player.getNome() + " Merlin viveu um  "
					...
					+ " um breve relacionamento com uma " + " camponesa e da\u00ED pode ter vindo sua "
					+ " fam\u00EDlia." + "";
			linhas[x + 7] = 7;
			...
			tx[x + 11] = "Guradam:" + "\n\n A j\u00F3ia do tempo, cujos rumores dizem "
					+ " que se encontra escondida sob a " + " Catedral. " + "";
			linhas[x + 11] = 4;

			tx[x + 12] = "Guradam:" + "\n\n E o Cajado de Merlin, que" + " na Alameda dos Três Ponteiros em "
					+ " seus subterrâneos onde um dia foi o " + " esconderijo de Elrond, um grande "
					+ " amigo de Merlin. " + "";
			linhas[x + 12] = 6;
			...
			tx[x + 12] = "Guradam:" + "\n\n E o Cajado de Merlin, que" + " infelizmente foi roubado de n\u00F3s "
					+ " recentemente. Imagino que ainda se" + " encontre nos armaz\u00E9ns da alameda "
					+ " dos 3 ponteiros " + "";
			linhas[x + 12] = 6;
	...
	public void torre() {
		...
		tx[2] = "Voc\u00EA:" + "\n\nExato, mas onde ele est\u00E1? Eu j\u00E1  "
				+ " revirei essa biblioteca inteira e o " + " m\u00E1ximo que vi foram men\u00E7\u00F5es a ele." + "";
		linhas[2] = 4;
	...
	public void torreDerrota() {
		...
		tx[0] = "Voc\u00EA pega o livro e um fluxo de " + " energia percorre o seu corpo. De "
				+ " repente tudo escureceâ€¦ Voc\u00EA acorda " + " em seu quarto, aos poucos as "
	...
	public void catedral() {
		...
		if (masculino) {
			...
			tx[2] = "Voc\u00EA:" + "\n\nVim em busca da joia do tempo. Dizem "
					+ " que ela se encontra sob esta Catedral." + "";
			linhas[2] = 3;
		...
		choice = "Voc\u00EA tem que chegar nas catacumbas de " + " qualquer jeito para conseguir a j\u00F3ia, mas "
	...
	public void catedral2(int y) {
		...
		tx[0 + x] = "Ap\u00F3s certo explorando tempo voc\u00EA " + " consegue sentir a presen\u00E7a da j\u00F3ia por"
		...
		tx[1 + x] = "Enquanto voc\u00EA segue a voz, voc\u00EA repara "
				...
				+ " alto, parecendo um animal selvagem. E " + " um forte cheiro de sangue invade o ar. "
	...
	public void catedralVitoria() {
		...
		tx[2] = "Cheia de tesouros, livros, tape\u00E7arias, " + " tudo de mais valor poss\u00EDvel, essa \u00E9 a "
				+ " sala que um dia foi de Merlin e, em " + " seu centro est\u00E1 a j\u00F3ia do tempo " + "";
		linhas[2] = 3;

		tx[3] = "\u00C9 dela que vem o chamado. Voc\u00EA vai " + " vat\u00E9 o pedestal e pega a joia. Voc\u00EA "
				...
				+ " de um teste para determinar se voc\u00EA " + " tinha o que \u00E9 necess\u00E1rio para usar a "
				+ " j\u00F3ia" + "";
		linhas[3] = 8;
	...
	public void alamedaVitoria() {
		...
		tx[0] = "Você consegue abrir a porta e entra   " + " no esconderijo de Elrond. Você não  "
				...
				+ " aproxima e pega o cetro. Nisso, um  " + " papel cai e você o pega para lê-lo.  "
				+ " Nele está escrito: " + "";
		linhas[0] = 6;
...
//		linhas[3] = 2;
	...
	public void vitoriaPerfectMatar() {
		...
		tx[0] = "As primeiras tropas que aparecem " + " são esmagadas, porém mais estão"
				+ " chegando. São muito numerosas, " + " apenas com feitiços simples não será "
				+ " possível contê-las. " + "";
		linhas[0] = 4;

		tx[1] = "Você se prepara para usar Maelstrom, " + " se lembra de todos que dependem de"
				+ " você, se lembra de seus pais que " + " morreram em decorrência da guerra e "
				+ " se lembra de Artemisia." + "";
		linhas[1] = 4;
...
//	public void itens2BIVitoria() == public void vitoriaPerfectPoup()
	...
	public void itens2BIDerrota() {
		...
		tx[2] = "Antes de morrer, você Artemisia " + " lutando perto e ela te dá um último "
				...
				+ " suficiente para pensar no que teria " + " acontecido se você tivesse feito o que "
				+ " deveria fazer." + "";
		linhas[2] = 8;

		tx[3] = "Assim termina a história de Helaria, " + " com o lamento de alguém que poderia "
				+ " ter feito diferente." + "";
		linhas[3] = 2;
	}
