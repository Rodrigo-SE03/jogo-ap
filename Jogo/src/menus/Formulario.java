	...
	private void initialize() {
		...
		ActionListener next = new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				...
				if(cont == txtNome.getText().length() || txtNome.getText().length()==0) {// Caso o Player n�o ponha nada no nome
					JOptionPane.showMessageDialog(null, "Desculpe, n�o poderei te deixar entrar sem que tenha um nome. Se n�o tiver um pode inventar. "
							+ "Helaria te dar� a chance de um novo come�o para sua vida.","Guarda: ",0);
				}
