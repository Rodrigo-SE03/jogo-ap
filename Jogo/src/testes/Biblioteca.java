...
public class Biblioteca {
			...
			private String[] tx;
			private String choice,op1,op2,op3;
			private int[] linhas;
			private int sexo;
			...
			public void inicio() { // 0 opções
				...
				tx[0]="<html>O dia amanheceu. Voce acorda e se"
			...
			public void inicio2() { // 2 opções
				...
				tx[1] = "<html> Você entra na cidade e procura pelo"
				...
				tx[2] = "<html>Chegando ao mercado você vê uma "
				...
				tx[3] = "<html>Você vai em direção a barraca "
				...
				choice = "<html>O homem que esbarrou em você"
			...
			public void inicio_artemis() { // 0 opções
				...
				tx[0] = "<html>Você pega novamente seus pertences "
				...
				tx[6] =  "<html>Artemisia vai embora e te deixa "
